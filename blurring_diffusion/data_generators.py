...
# num_communities만큼 random graph 만들고 각 community에 edge 더 추가해주는 건가
def n_community(num_communities, max_nodes, p_inter=0.05): 
    # -------- From Niu et al. (2020) --------
    assert num_communities > 1
    
    one_community_size = max_nodes // num_communities # 14 // 2
    c_sizes = [one_community_size] * num_communities # [7] * 2 = [7, 7]
    total_nodes = one_community_size * num_communities # 7 * 2
