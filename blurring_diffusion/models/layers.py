...
class DenseGCNConv(torch.nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, emb_dim = 256, improved=False, bias=True):
    ...
    def forward(self, x, adj, t, mask=None, add_loop=True):
        r"""
        Args:
        ...
        emb = self.emb_layer(t)[:, None].repeat(1, out.shape[-2], 1)
